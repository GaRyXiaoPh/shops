...
public enum EosApiErrorCode implements ErrorCode {
    ...
    static {
        for (com.cmd.wallet.blockchain.eos.exception.EosApiErrorCode errorCode : com.cmd.wallet.blockchain.eos.exception.EosApiErrorCode.values())
    ...
    public static com.cmd.wallet.blockchain.eos.exception.EosApiErrorCode get(Integer number) {
