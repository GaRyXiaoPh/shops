...
public class SimpleMailUtil {
    ...
    public static void main(String [] argv){
        ...
        SimpleMailUtil.EmailProperty info = new SimpleMailUtil.EmailProperty()
                .setMailFromAddress("service@service.eng11.net").setMailUserName("service@service.eng11.net").setMailPassword("engQWERTY123")
                .setMailServerHost("smtpdm.aliyun.com").setMailServerPort("80").setValidate(true);
