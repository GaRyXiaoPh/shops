...
public class ArticleController {
    ...
    public CommonResponse<List<ArticleVo>> getArticleListByLocale(
            @ApiParam(value = "NOTICE: 公告， NEWS：资讯") @RequestParam ArticleType type,
            @ApiParam(value = "en_US: 英文, zh_CN: 中文简体 zh_TW:中文繁体") @RequestParam String locale
    ) {
        List<ArticleVo> articleList = articleService.getArticleList(type,locale);
        return new CommonResponse<>(articleList);
    }
